...
def recognize_from_image(net, det_net, image):
    # input image loop
    for image_path in args.input:
        ...
        img,pred = vis_pose_result(img, pose_results)
...
def recognize(img):
    ...
    return recognize_from_image(net, det_net, img)
